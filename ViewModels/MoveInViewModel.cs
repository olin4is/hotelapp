    ...
    class MoveInViewModel : INotifyPropertyChanged
    {
        ...
        public void CreateDocument()
        {
            ...
            secondPartText = "2.1.Исполнитель обязуется обеспечить круглосуточное размещение " +
                ...
                "\r\n2.2.Заявка на бронирование производится Заказчиком в письменном виде, по факсу, " +
                "телефону, либо посредством электронной почты, указанных в разделе 7 настоящего договора. " +
                "Она должна включать в себя Ф.И.О., название фирмы, данные паспорта или иного документа, " +
                "удостоверяющего личность Заказчика, дату и время въезда, дату и время выезда, категорию " +
                "номера, перечень дополнительных услуг. " +
